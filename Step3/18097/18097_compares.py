...
factor = np.max(light_profile_x4)
...
peak_flux1 = np.max(light_profile_x1)
normalization_factor1 = factor / peak_flux1

# Normalize the light profile along the x-axis
normalized_light_profile_x1 = light_profile_x1 * normalization_factor1
...
peak_flux2 = np.max(light_profile_x2)
normalization_factor2 = factor / peak_flux2
normalized_light_profile_x2 = light_profile_x2 * normalization_factor2
...
peak_flux3 = np.max(light_profile_x3)
normalization_factor3 = factor / peak_flux3
normalized_light_profile_x3 = light_profile_x3 * normalization_factor3
...
plt.plot(x_coords4, light_profile_x4, 'd-', color='purple', label='Object')
